                ...
                <div class="col-lg-12 col-md-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('Type:'.$type) }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 col-md-9">
                    <h1 class="mb-0 mt-0">{{ __('Type:'.$type)  }}</h1>
                    <hr>
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="big-item">
                                                <a href="{{ uri('post', $post->slug) }}"><img
                                                        src="{{ image_url($post->images->featured_image, '700x394') }}"
                                                        alt="{{ $post->title }}"></a>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <h4><a href="{{ uri('post', $post->slug) }}">{{ $post->title }}</a>
                                            </h4>
                                            <p>{{ Str::limit($post->description, 300, $end = '...') }}
                                            </p>
