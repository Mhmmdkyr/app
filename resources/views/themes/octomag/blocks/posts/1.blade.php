        ...
        <div class="card-header">
            <div class="row">
                <div class="col-lg-4 col-md-4"><span
                        class="card-rounded-title category-{{ $item->id }}"><i class="fas fa-genderless"></i> {{ $item->category_title }}</span></div>
        ...
        <div class="card-body gray-area">
            <div class="row" style="position: relative; z-index: 12;">
                <div class="col-lg-6 col-md-6">
                    <div class="big-item">
                        <a href="{{ uri('post', $item->posts[0]->slug)}}"><img src="{{ image_url('placeholders/lg.jpg', '700x394') }}" data-src="{{ image_url($item->posts[0]->images->featured_image, '700x394') }}"
                            alt="{{ $item->posts[0]->title }}" class="lazy"></a>
                    ...
                    <div class="list-items with-img">
                        <ul class="list-item">
                            @foreach ($item->posts as $i => $post)
                                @if ($i != 0 && $i < 5)
                                    <li><a href="{{ uri('post', $post->slug)}}"><img src="{{ image_url('placeholders/lg.jpg', '500x281') }}"
